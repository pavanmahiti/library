...
def dashboard(request):
    # its dashboard page where am doing 4 analysis
    # 1. Num of books out of stock
    # 2. Num of books borrowed by each customer
    # 3. Num of customers joined from last week
    # 4. Num of customers are over due to return
    ...
    new_customers = Customer.objects.filter(created__range=[from_date,
                    datetime.now()])
